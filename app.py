...
import pickle
import numpy as np
# model=pickle.load(open('C:/Users/User/Downloads/carprice/car price/random_forest_regression_model.pkl','rb'))
# model=pickle.load(open('E:/Work/Machine Learning/GSYAY APP/random_forest_regression_model.pkl','rb'))
model=pickle.load(open('E:/Work/machine learning/carprice/random_forest_regression_model.pkl','rb'))
